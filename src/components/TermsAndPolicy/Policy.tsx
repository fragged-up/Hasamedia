const Policy = () => {
  return (
    <div className="container dialog-text">
      ...
      <div className="defenitions">
        ...
        <ul>
          ...
          <li>
            ...
            Agreement) refers to hasamedia, 1 Cupertino,CA 95014.
          </li>
          <li>
          ...
          <li>
            <strong>Personal Data</strong>s any information that relates to an
          ...
          <li>
            ...
            refers to hasamedia, accessible from https://hasamedia.io
          </li>
          <li>
      ...
      <div>
        ...
        <ul>
          ...
          <li>
            ...
            <p>Type: Persistent Cookies Administered by:</p>
            <p>Us Purpose: These Cookies</p>
            <p>
      ...
      <div className="use-your-personal-data">
      ...
      <div className="disclousre-of-your-personal-data">
        ...
        <div className="law-enforcements">
        ...
        <div className="other-legal-requirements">
          <h2>Other legal requirments</h2>
          <p>
        ...
        <div className="security-of-your-personal-data">
      ...
      <footer>
        ...
        <div className="changes-to-this-privacy-policy">
          <h2>Change to this Privacy Policy</h2>
          <p>
        ...
        <div>
          ...
          <ul>
            <li>By email: hasamedia@company.com</li>
          </ul>
        </div>
      </footer>
    </div>
