    ...
    <div className="container dialog-text">
      <div className="container mx-auto py-10 px-4">
        ...
        <p className="mb-4">
          ...
          HasaMedia for your own personal use subjected to restrictions set in
        ...
        <p className="mb-4">
          HasaMedia will not be liable for any damages arising out of or in
          connection with your use of this website. This includes, without
          limitation, direct loss, loss of business or profits, damage caused to
          your computer, software, systems and programs, and the data thereon,
        ...
        <p className="mb-4">
          ...
          complete, or current. HasaMedia may make changes to the materials
